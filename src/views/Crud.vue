  ...
  <div>
    ...
    <div class="container mt-4">
      ...
      <div class="col-3 offset-9 text-right my-3">
        <button @click="increment" class="btn btn-sm btn-secondary">+</button>
        <button @click="decrement" class="btn btn-sm btn-secondary">-</button>
        {{ value }}
...
export default {
  ...
  methods: {
    ...
    increment(){
      //use vuex for use communication value in child
      /*this.$store.commit('increment');
      this.$store.commit('add_increment',10);*/
      this.$store.dispatch('increment_act')
      this.$store.dispatch('add_increment_act',10)
      this.value = this.$store.state.count;
      console.log(this.$store.state.count);
      //show data with getters
      console.log(this.$store.getters.double_data);
    },
    decrement(){
      /*this.$store.commit('decrement');
      this.$store.commit('min_decrement',10);*/
      this.$store.dispatch('decrement_act')
      this.$store.dispatch('min_decrement_act',10)
      this.value = this.$store.state.count;
      console.log(this.$store.state.count);
      //show data with getters
      console.log(this.$store.getters.double_data);
